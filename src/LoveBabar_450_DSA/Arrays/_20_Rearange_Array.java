...
public class _20_Rearange_Array {
    ...
    {
        _20_Rearange_Array rearrange = new _20_Rearange_Array();
        /* int arr[n] = {-5, 3, 4, 5, -6,
                         -2, 8, 9, -1, -4};
        int arr[] = {-5, -3, -4, -5, -6,
                     2 , 8, 9, 1 , 4};
...
Time Complexity: O(N^2), as we are using a loop to traverse N times and calling function to right
                        rotate each time which will cost O (N).
Auxiliary Space: O(1).
 */